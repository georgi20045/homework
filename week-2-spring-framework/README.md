...
- [Конфигурация в Spring](#configuration-spring)
...
![Post Construct Annotation](images/4.bean-lifecycle.png)
...
<a id="spring-boot-application-annotation"></a>
## VI. @SpringBootApplication

Анотацията **@SpringBootApplication** в Spring Boot е най-важната начална точка на всяко Spring Boot приложение.
Тя се поставя върху главния клас (този с main метода) и казва на Spring: „това е стартът на моето приложение
и трябва да конфигурираш всичко автоматично около него“.

![@SpringBootApplication annotation](images/5.start-spring-boot-app.png)

По същество **@SpringBootApplication** не е една единствена анотация, а комбинация от три други анотации,
събрани в една, за удобство. Това са **@SpringBootConfiguration**, **@EnableAutoConfiguration** и **@ComponentScan**.
Всяка от тях има различна роля, но заедно изграждат цялата логика на стартиране на приложението.

![@SpringBootApplication annotation details](images/6.spring-boot-application-annotation.png)

Първата част, **@SpringBootConfiguration**, показва, че този клас е конфигурационен клас. Това означава,
че Spring може да използва този клас като източник на настройки и bean дефиниции. Тя е специален вариант 
на стандартната @Configuration, но е адаптирана за Spring Boot.

Втората и най-важна част е **@EnableAutoConfiguration**. Тя е „магията“ на Spring Boot. Когато приложението стартира,
тази анотация казва на Spring: „погледни какви библиотеки има в проекта и автоматично конфигурирай всичко
необходимо“. Например, ако имаш dependency за Spring Web, Spring автоматично ще стартира embedded сървър
като Apache Tomcat. Ако имаш база данни, ще конфигурира DataSource. Ако имаш Jackson, ще настрои JSON обработка. Всичко това става без да пишеш ръчна конфигурация.

Третата част е @ComponentScan. Тя казва на Spring да сканира пакетите в проекта и да търси класове, които са
маркирани с анотации като **@Controller**, **@Service**, **@Repository** или **@Component**. Когато ги намери,
Spring автоматично ги създава като обекти (beans) и ги добавя в своя контекст, за да могат да се използват навсякъде чрез dependency injection.

<a id="resources"></a>
## VII. Допълнителни материали
